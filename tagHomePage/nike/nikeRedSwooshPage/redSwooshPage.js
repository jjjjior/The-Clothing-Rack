...
function mouseEnter(){
    $(".tag1-green").attr("src", "images/tagImages/nikeLate1990sRedSwooshBlackTag-raw.png");
}
function mouseExit(){
    $(".tag1-green").attr("src", "images/tagImages/nikeLate1990sRedSwooshBlackTag-green.png");
}
